"""
Django settings for LineGest project.
"""
...
ADMINS = [
    ('Mickaël', 'mickael@example.com'),
]
MANAGERS = ADMINS

# Email configuration
EMAIL_SUBJECT_PREFIX = '[LineGest] '
DEFAULT_FROM_EMAIL = 'mickael@example.com'
